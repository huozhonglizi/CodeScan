...
public class FloatingGroupExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    public FloatingGroupExpandableListViewAdapter(ExpandableListAdapter adapter) {
        mWrappedAdapter = adapter;
    }
    
    public ExpandableListAdapter getmWrappedAdapter() {
