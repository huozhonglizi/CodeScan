...
package com.wl.codescan.zxing.camera;
...
public final class CameraManager {
	...
	private CameraManager(Context context) {
		...
		int screenWidth=DataCache.SCREEN_WIDTH;
		int screenHeight=DataCache.SCREEN_HEIGHT;
		MIN_FRAME_WIDTH=screenWidth/480*MIN_FRAME_WIDTH;
		MIN_FRAME_HEIGHT=screenHeight/800*MIN_FRAME_HEIGHT;
		MAX_FRAME_WIDTH=screenWidth/480*MAX_FRAME_WIDTH;
		MAX_FRAME_HEIGHT=screenHeight/800*MAX_FRAME_HEIGHT;
